  ...
  return [
    {
      ...
      label: "Add Apply Destination",
      incompleteLabel: "No candidate contact method",
      message: "Add a default apply URL or email before publishing jobs.",
      whyItMatters: "Published recruiter jobs need a destination for candidates.",
